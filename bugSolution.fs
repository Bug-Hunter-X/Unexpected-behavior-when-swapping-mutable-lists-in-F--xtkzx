...
let swapListCorrect x y = 
    let temp = List.copy x
    x <- List.copy y
    y <- temp

let mutable a1 = [1;2;3]
let mutable b1 = [4;5;6]

swapListCorrect a1 b1
printf "%A %A" a1 b1 //This will print [4;5;6] [1;2;3] which is the expected result